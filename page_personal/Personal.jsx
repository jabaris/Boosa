...
import TravelHistoryMobileImg from '../Images/personal_pageTravelHistoryMobileImg.svg';
                            ...
                            <div className='Main-container_inner_travelHistory_inner'>
                                ...
                                <div className="Main-container_inner_travelHistory_inner_column">
                                    <div className="Main-container_inner_travelHistory_inner_column_item">
                                        ...
                                        <img src={TravelHistoryMobileImg} className='Main-container_inner_travelHistory_inner_column_item_mobileImg' alt="" />
                            ...
                            <div className="Main-container_inner_sendingHistory_inner">
                                ...
                                <div className="Main-container_inner_sendingHistory_inner_column">
                                    <div className="Main-container_inner_sendingHistory_inner_column_item">
                                        ...
                                        <img src={TravelHistoryMobileImg} className='Main-container_inner_sendingHistory_inner_column_item_termsOfSending_mobileImg' alt="" />
                                            <div className="Main-container_inner_sendingHistory_inner_column_item_termsOfSending_cityFromWhere">
                                                Махачкала
                                            </div>
                                            <div className="Main-container_inner_sendingHistory_inner_column_item_termsOfSending_timeMobile">
                                                с: 17 ноября - до: 30 ноября
                                            </div>
                                            <div className="Main-container_inner_sendingHistory_inner_column_item_termsOfSending_icons">
                                                <img src={TravelIcon} alt="" />
                                                <p>Поездом,</p>
